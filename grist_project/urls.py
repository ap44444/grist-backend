...
urlpatterns = [
                ...
                # Daily tracking
                  ...
                  path('api/dietitian/manage/identity/', core_views.DietitianIdentityView.as_view(),
                       name='dietitian_identity_crud'),
                  path('api/dietitian/manage/media/', core_views.DietitianMediaView.as_view(),
                       name='dietitian_media_crud'),
